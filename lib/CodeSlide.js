...
var CodeSlideControlHelpers = require('./CodeSlideControlHelpers');
  ...
  _createClass(CodeSlide, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          withControlHelpers = _props2.withControlHelpers,
          rest = _objectWithoutProperties(_props2, ['code', 'lang', 'ranges', 'color', 'bgColor', 'notes', 'showLineNumbers', 'withControlHelpers']);
      ...
      return React.createElement(
        ...
        withControlHelpers && React.createElement(CodeSlideControlHelpers, { hasNextRange: active < ranges.length - 1, pristine: active === 0 })
      );
    }
  }]);
